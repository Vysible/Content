...
const clients = [
  { name: 'Bachmann',                canvaFolderId: 'FAHGQkZVhXA', canvaBrandKitId: 'kAHJvgJaGXc' },
  ...
  { name: 'My.Ortho',                canvaFolderId: 'FAHJuUtyeq4', canvaBrandKitId: 'kAHJvmrl9jw' },
  ...
  { name: 'Warendorf / Morawek',     canvaFolderId: 'FADrxJRG68E', canvaBrandKitId: 'kAHJvmdm3fk' },
  { name: 'Zahnraum',                canvaFolderId: 'FAHJuQswO_U', canvaBrandKitId: 'kAHJu9MD38Y' },
  { name: 'Zahnteam Bad Laer',       canvaFolderId: 'FADrxMud1WY', canvaBrandKitId: 'kAHJvpGXrT4' },
