...
### Fixed
- **GA4 Service Account in Coolify:** `GA4_SERVICE_ACCOUNT_JSON` wird vor `JSON.parse` normalisiert (escaped Quotes `\"`, äußere Anführungszeichen) — GA4 funktioniert auch wenn Coolify das JSON anders escaped speichert als lokal in `.env`.
